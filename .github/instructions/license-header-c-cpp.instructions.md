...
- **Year**: Replace `[Year]` in the header template with the current copyright year for new files. Keep the original years for existing files.
- **Author Name**: Replace `[Author Name]` in the header template with your full legal name.
- **Email**: Replace `[Email]` in the header template with your email address associated with your GitHub account.
